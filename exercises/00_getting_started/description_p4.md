...
2. Click **Save & Run** in the top bar
...
The framework is installed, the test program runs, and you understand the basic edit–save–run cycle. Move on to **Exercise 01: Button Light** to start building real hardware applications.
