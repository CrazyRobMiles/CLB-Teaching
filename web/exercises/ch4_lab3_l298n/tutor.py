...
EXERCISE = {
    ...
    "off_limits": [
        ...
        "the minimum duty cycle at which their specific motor starts â€” this must be measured",
        "why common ground between motor supply and Pico is essential â€” reason it through with them",
    ],
    ...
    "hints": [
        ...
        "The ENA duty cycle controls speed â€” 0 is off, 65535 is full speed. "
        "Try in1.value(1), in2.value(0), ena.duty_u16(32768) in the console.",

        # Hint 3
        "To coast (free spin), set both direction pins low and ENA to 0. "
        "To brake (fast stop), try setting IN1=1 and IN2=1 â€” think about what "
        "that does to the motor terminals according to the H-bridge diagram.",

        # Hint 4
        "With IN1=IN2=1, both motor terminals are connected to +V â€” no current can flow "
        ...
        # Hint 5
        "If the motor does not start at low duty cycles, that is normal â€” motors need a "
    ...
    "observation_checklist": [
        ...
        "Is the motor humming but not turning? The duty cycle may be below the motor's stall threshold â€” try 65535.",
        "Is the motor running but not changing direction? Double-check IN1/IN2 are set before checking ENA.",
        "Is the Pico resetting or browning out? The motor supply and Pico supply must share a common ground â€” check wiring.",
        "Try ena.duty_u16(0) â€” does the motor stop? That confirms ENA is wired correctly.",
    ],
...
is no code file to write â€” the student types commands directly in the console to
...
acknowledge it: "That's a clear description â€” you've told me what you expected,
...
under software control is genuinely exciting â€” acknowledge it. Brief is better
...
has just crossed a fundamental boundary â€” from controlling milliamps of LED
