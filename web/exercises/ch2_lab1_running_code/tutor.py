...
EXERCISE = {
    ...
    "hints": [
        ...
        "A file called blink.py or ch1_lab3.py does nothing on its own — it has to "
    ...
    "observation_checklist": [
        ...
        "Try running exec(open('/main.py').read()) — what happens?",
    ],
...
TONE
Keep it practical. The filesystem model is simple once seen — the goal is to
