# Exercise ch1_lab1_led_test: Lab 1 — LED Test
...
EXERCISE = {
    "id": "ch1_lab1_led_test",
    "phase": 1,
    "title": "Lab 1: LED Test",
    "concept": "basic circuits and hardware verification",

    "objective": (
        "Wire a LED and 220 Ω resistor to the Pico's 3.3 V supply and GND, "
    ...
    # This lab involves no code — the off-limits list covers circuit judgements
    ...
    "hints": [
        # Hint 1
        "LEDs have polarity — they only light up in one direction. The longer leg "
        ...
        "try a different LED from your kit — LEDs can arrive dead from the factory. "
        "A 470 Ω resistor is also fine if you can't find a 220 Ω; the LED will be "
        "dimmer but should glow.",

        # Hint 4
        "Double-check that you're using Pico physical pin 36 (3V3(OUT)) and physical "
        "pin 38 (GND). The physical pin numbers run 1–40 around the board; pin 36 "
    ...
    "success_indicators": [
        ...
        "LED lights up without any code or commands — purely from the 3.3 V supply",
...
wire a LED and 220 Ω resistor from the Pico's 3.3 V pin (physical pin 36) to
...
- Why a current-limiting resistor is needed (Ohm's law: R = V/I, ~220 Ω for 15 mA at 3.3 V)
...
- Do not skip straight to "swap the LED" — walk through the checklist first.
...
acknowledge it explicitly: "Good — you've described what you see and how it's
...
independently of software. This is a real engineering practice — hardware-first
