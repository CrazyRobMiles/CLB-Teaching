...
EXERCISE = {
    ...
    "hints": [
        ...
        "USB cable — many cheap cables carry power only and have no data wires. "
        ...
        "Run, check that main.py was saved correctly — the editor tab shows a ● when "
        "there are unsaved changes. Try clicking Run again.",

        "If the console shows a Traceback after Run, check the code in the editor. "
        "A simple print(\"Hello World\") should not error — make sure there are no "
    ...
    "observation_checklist": [
        "What does the browser show when you click Connect Device — a port list, an error, or nothing?",
...
This student is working on Getting Started — pure setup, no circuit to build.
...
- Do not do the diagnosis for the student — ask them what they observe first.
...
TONE
Be welcoming — this is likely the student's first time with embedded hardware.
